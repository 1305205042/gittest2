...
(function ($, window, document, undefined) {
    ...
    function generateNavigation($el, count, config) {
        ...
        html += "<ol class='" + config.navigationClass + "' style='padding:5px'>";
        for (i = 0; i < count; i++) {
		...
		//$('.slider-prev').after($('.'+config.navigationClass))
    }
    ...
    function sweepIn($el, windowWidth, frameLeft) {
        ...
        $el.css({ opacity: 0, display: "inline-block" }); // move it outside the right edge of the screen
    ...
    TlrkSlider.prototype = {
        defaults: {
            ...
            disposeSpeed: 700, // how quickly they'll fadeOut/In

            delayBetweenTransition: 700, // time between starting fadeOut and fadeIn
...
$(document).ready(function () {
    ...
    $(".header-content")
      .hover(
        ...
        function () { if ($.isFunction(c.animationEnd)) { c.animationEnd.apply(that, arguments); } }
      )
    ...
    $('#divGoNav0').bind('click', function () {
        $("#slider").tlrkSlider("go", "0");
        window.location.href = "#product";
    });
    $('#divGoNav5').bind('click', function () {
        $("#slider").tlrkSlider("go", "5");
        window.location.href = "#product";
    });
    $('#divGoNav6').bind('click', function () {
        $("#slider").tlrkSlider("go", "6");
        window.location.href = "#product";
    });
    $('#divGoNav7').bind('click', function () {
        $("#slider").tlrkSlider("go", "7");
        window.location.href = "#product";
    });
});